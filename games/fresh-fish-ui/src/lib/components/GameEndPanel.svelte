...
<div
    ...
    class="mb-2 rounded-lg bg-gray-300 px-2 pt-2 pb-4 text-center flex flex-row flex-wrap justify-center items-center overflow-hidden"
>
        ...
        <div class="flex flex-row justify-center items-center mb-2">
            {#if isWin}
                <h1 class="text-lg">
                    ...
                    >
                    is the winner with a score of {gameSession.hydratedState.getPlayerState(
                        winner ?? 'anyone'
                    )?.score}
                </h1>
            {:else}
                    ...
                    <div class="text-sm flex flex-col justify-center items-start w-full">
                        {#each player.stalls as stall}
                            <div class="flex flex-row justify-between items-center w-full">
                                <div class="mr-8">{gameSession.getGoodsName(stall.goodsType)}</div>
                                <div>
                                    -{stall.distance
                        ...
                        <div class="flex flex-row justify-between items-center w-full mt-3 mb-2">
                            <div>total</div>
