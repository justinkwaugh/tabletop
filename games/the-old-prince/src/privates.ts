...
export const TheOldPrincePrivates = [
    ...
    { id: 'IB', name: 'Ice Boats', price: 40, revenue: 5 },
    { id: 'RA', name: 'Royal Agricultural Society', price: 110, revenue: 10 },
    { id: 'RF', name: 'Railcar Ferry', price: 120, revenue: 15 },
    { id: 'SB', name: 'Shipbuilding', price: 90, revenue: 15 },
    { id: 'HS', name: 'Hunslet Steam Engine', price: 110, revenue: 20 },
