...
Numbered certificate identities sometimes carry rights beyond percentage ownership: TOP's PEIR rights identify future railways, unlike interchangeable ordinary shares in 1889/1830. Existing certificate numbers and canonical ownership supply the player-card detail; title-owned number-to-name presentation supplies the railway names. Companies with this detail appear after ordinary ownership and show their owned numbers in numeric order. The shared panel does not infer special rights from a company ID or apply numbered details to every certificate. This preserves the researched distinction between ordinary shares and changing numbered entitlements without adding a new financial model.
