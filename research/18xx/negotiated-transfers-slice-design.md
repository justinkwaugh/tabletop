...
## Automatic completion of train buying

The acquisition and interruption variations above rule out testing only depot
stock, cash, or a fixed train count to end this step. The completion wrapper
consults the fully composed handler instead: FinishOperatingTurn must be legal,
and no active player may have another legal action. This preserves intercompany
transfers, private powers, emergency funding, and seller responses. It imposes no
universal train purchase limit or assumption that reaching the depot allowance
ends an operation. TOP and 1889 cash-exhaustion tests cover automatic completion
and reversing its full action batch; negotiated-transfer tests cover retained
choices. The finished TOP fixture keeps 1,071 processed actions and final wealth,
with 14 former manual end-turn commands now generated by the engine.
